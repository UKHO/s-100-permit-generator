...
namespace UKHO.S100PermitService.API.UnitTests.Controller
{
    ...
    public class PermitControllerTests
    {
        ...
        private IManufacturerKeyService _fakeManufacturerKeys;
        ...
        public void Setup()
        {
            ...
            _fakeManufacturerKeys = A.Fake<IManufacturerKeyService>();
            _permitController = new PermitController(_fakeHttpContextAccessor, _fakeLogger, _fakePermitService, _fakeManufacturerKeys);
        }

        [Test]
        public void WhenParameterIsNull_ThenConstructorThrowsArgumentNullException()
        {
            Action nullLogger = () => new PermitController(_fakeHttpContextAccessor, null, _fakePermitService, _fakeManufacturerKeys);
            nullLogger.Should().ThrowExactly<ArgumentNullException>().And.ParamName.Should().Be("logger");

            Action nullPermitService = () => new PermitController(_fakeHttpContextAccessor, _fakeLogger, null, _fakeManufacturerKeys);
